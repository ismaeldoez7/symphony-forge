...
2. In `factory/tests/test_gates.py`, add the valid grouped function-body raw-launch case and its nested `$()` equivalent to the existing deny matrix. Preserve all existing positive and negative controls.
